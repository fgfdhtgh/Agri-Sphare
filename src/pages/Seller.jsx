...
const SellerPage = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
            ...
            //const seller = await firebase.CreateNewSeller(username, email, phone, password);
    ...
    return (
        <div className="absolute w-full fixed top-0 z-20 flex justify-center items-center min-h-screen bg-black/30">
            <div className="w-full max-w-5xl h-[90vh] rounded-xl bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('https://nufarm.com/ca/wp-content/uploads/sites/16/2018/06/Farmer-in-Canola-Field-at-Sunset-Alamy-Stock-Image.jpg')" }}>
